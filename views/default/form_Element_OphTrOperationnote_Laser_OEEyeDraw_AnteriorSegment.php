 ...
 */
?>
<section class="sub-element anterior-segment">
...
<input type="hidden" name="<?php echo CHtml::modelName($element)?>[antseg]" value=""<?php if ($element->antseg) {?> disabled="disabled"<?php }?> />
