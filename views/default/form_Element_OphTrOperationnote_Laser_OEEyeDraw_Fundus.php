 ...
 */
?>
<section class="sub-element fundus">
	<header class="sub-element-header">
		<h4 class="sub-element-title">Fundus</h4>
	</header>
...
<input type="hidden" name="<?php echo CHtml::modelName($element)?>[fundus]" value=""<?php if ($element->fundus) {?> disabled="disabled"<?php }?> />
