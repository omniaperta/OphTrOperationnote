		...
		<div class="fluid column">
			<div class="row">
				<div class="large-12 column">
					...
					<?php echo $form->multiSelectList($element, 'complications', 'complications', 'id', CHtml::listData(OphTrOperationnote_CataractComplications::model()->activeOrPk($element->cataractComplicationValues)->findAll(array('order'=>'display_order asc')), 'id', 'name'), null, array('empty' => '- Complications -', 'label' => 'Complications'),false,false,null,false,false,array('field'=>4))?>
