...
class Element_OphTrOperationnote_PatientDischarge extends Element_OpNote
{
	...
	{
		return 'et_ophtroperationnote_patientdischarge';
	}
	...
	public function rules()
	{
		...
		return array(
			array('tolerated_procedure, ocular_stable', 'safe'),
			array('tolerated_procedure, ocular_stable', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, tolerated_procedure, ocular_stable', 'safe', 'on' => 'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'tolerated_procedure' => 'Patient was found to tolerate procedure well and has acceptable control of pain',
			'ocular_stable' => 'Ocular system is in stable condition to warrant discharge',
		);
	}
